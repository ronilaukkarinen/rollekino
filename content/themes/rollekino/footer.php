...
<footer id="colophon" class="site-footer has-dark-bg">
  ...
  <div class="site-info">
    <a class="no-text-link powered-by-wordpress" href="<?php echo esc_url( __( 'http://wordpress.org/', 'rollekino' ) ); ?>">
      ...
      <span>
        <?php printf( esc_html__( 'Proudly powered by %s', 'rollekino' ), 'WordPress' ); ?>.
      </span>
    </a>
    <span class="theme-info">
      <?php printf( esc_html__( 'Lightweight like %1$s itself. You are using version %2$s', 'rollekino' ), '<i>air</i>', esc_attr( AIR_LIGHT_VERSION ) ); ?>
      <a class="no-text-link github-link" href="<?php echo esc_url( __( 'https://github.com/digitoimistodude/air', 'rollekino' ) ); ?>">
