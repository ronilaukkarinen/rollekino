 ...
 */
define( 'AIR_LIGHT_VERSION', '7.6.0' );
...
add_action( 'after_setup_theme', function() {
  $theme_settings = [
     ...
     */
    'menu_locations' => [
      'primary' => __( 'Primary Menu', 'rollekino' ),
    ],
