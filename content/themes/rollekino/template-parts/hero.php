...
<section class="block block-hero block-hero-normal block-hero-movies<?php echo esc_attr( implode( ' ', $block_classes ) ); ?>">
  ...
  <div class="container">
    <div class="content">
      <h1 class="block-title"><?php the_title(); ?></h1>
      <p class="block-description block-description-quote"><?php echo esc_html( get_the_date( 'j.n.Y', get_the_ID() ) ); ?> <span class="auth"><a href="https://twitter.com/rolle"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/gravatar.jpg" alt="Roni Laukkarinen" class="gravatar-small" /> <span class="name">@rolle</span></a></span></p>
    </div>
